...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    #add test code here
    volume_of_cube_result = volume_of_cube(2, 6, 2)
    assert_equal(24, volume_of_cube_result)
  end
  ...
  def test_volume_of_sphere()
    ...
    assert_equal(113.076, volume_of_sphere_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_to_celsius_result = fahrenheit_to_celsius(100)
    assert_equal(37.7778, fahrenheit_to_celsius_result)
  end
